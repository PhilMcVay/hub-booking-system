...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { booking_id_id: @detail.booking_id_id, company: @detail.company, email: @detail.email, membership: @detail.membership, name: @detail.name, other_notes: @detail.other_notes } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { booking_id_id: @detail.booking_id_id, company: @detail.company, email: @detail.email, membership: @detail.membership, name: @detail.name, other_notes: @detail.other_notes } }
