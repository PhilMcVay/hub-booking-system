...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { capacity: @area.capacity, image: @area.image, name: @area.name, type: @area.type } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { capacity: @area.capacity, image: @area.image, name: @area.name, type: @area.type } }
